      ...
      >
        {isLoggedIn ?
          (
            ...
            <li className="mb-1 mt-1 md:mb-0 rounded-xl bg-gray-300 px-4 p-2 hover:underline hidden md:block"><Link to=""><CiLogout size={25}/></Link></li>
            <li><Link to={pathConstants.PROFILE} className="hover:underline">
              ...
              <li className="mb-1 mt-1 md:hidden"><a href="home" className="hover:underline">Logout</a></li>
